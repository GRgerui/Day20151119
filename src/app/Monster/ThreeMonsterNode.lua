local ThreeMonsterNode = class("ThreeMonsterNode", function( )
	return display.newNode()
end)
function ThreeMonsterNode:ctor()
    self.Zt = false
	self:init()
end
function ThreeMonsterNode:init()
    local func = cca.callFunc(function ()
        --创建和添加怪物 3 
        self.Ms3 = ThreeMonster:new()
        self.Ms3:setPosition(0,110)
        self:addChild(self.Ms3)
        --添加血条
...
function ThreeMonsterNode:MsProgressTimer()
...
function ThreeMonsterNode:GoonMs() --跟随人物
